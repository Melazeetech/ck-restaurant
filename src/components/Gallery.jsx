...
export default function Gallery() {
  ...
  return (
    <section id="gallery" className="relative py-24 bg-[#080303] overflow-hidden">
      {/* Decorative elements */}
      <div className="absolute top-1/4 -right-64 w-[500px] h-[500px] bg-brand-red/5 rounded-full blur-[150px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
            ...
            >
              ...
              <div className="relative w-full h-full rounded-xl overflow-hidden">
                ...
                <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-between p-6">
                  ...
                  {/* Top: Tag */}
                  <span className="self-start px-3 py-1 rounded-full bg-brand-red text-[9px] font-bold text-white uppercase tracking-wider">
                    {image.tag}
                  </span>
                  ...
                  <div className="flex justify-between items-end">
                    ...
                    <div className="w-10 h-10 rounded-full bg-brand-red text-white flex items-center justify-center shadow-lg transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
        ...
        <div className="mt-16 text-center">
          <a
            ...
            className="inline-flex items-center gap-2 px-6 py-3.5 rounded-full glass-panel hover:bg-white/5 text-white text-xs font-semibold uppercase tracking-wider border border-white/10 hover:border-brand-red/30 transition-all duration-300 hover:scale-105"
          >
            <svg className="w-4 h-4 text-brand-accent" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <AnimatePresence>
        {selectedImage && (
          ...
          >
            ...
            <button
              onClick={() => setSelectedImage(null)}
              className="absolute top-6 right-6 p-3 rounded-full bg-white/5 border border-white/10 hover:border-brand-red hover:bg-brand-red text-white transition-all z-50"
            ...
            <motion.div
              ...
              className="relative max-w-5xl w-full flex flex-col items-center bg-[#120a0a]/80 p-3 rounded-2xl border border-white/10 shadow-2xl"
            >
              <img
