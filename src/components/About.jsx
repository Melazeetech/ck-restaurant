      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6 flex flex-col justify-center">
            <span className="text-brand-accent text-xs font-semibold uppercase tracking-[0.25em] mb-3">
              The CK Experience
            </span>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-4 border-t border-white/10">
              <div className="flex flex-col gap-2">
                <div className="w-10 h-10 rounded-full glass-panel flex items-center justify-center text-brand-accent">
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="text-xs text-gray-400 font-light leading-snug">Luxury dark red ambiance and relaxing spaces.</p>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-6 relative mt-8 lg:mt-0 flex justify-center items-center">
            {/* Ambient Red glow behind images */}
            <div className="absolute w-72 h-72 rounded-full bg-brand-red/10 blur-[80px] pointer-events-none" />
            ...
            <div className="relative w-full max-w-lg grid grid-cols-12 gap-4">
              ...
              <motion.div 
                ...
                transition={{ duration: 0.4 }}
                className="col-span-6 col-start-7 -translate-y-24 rounded-2xl overflow-hidden glass-panel p-2 shadow-2xl border-brand-red/20"
              >
                <img 
              ...
              <motion.div 
                ...
                className="absolute bottom-6 left-6 md:-left-6 px-6 py-4 rounded-xl glass-panel text-left flex flex-col shadow-lg border border-brand-red/30"
              >
                <span className="font-serif text-3xl font-bold text-white tracking-tight">100%</span>
                <span className="text-[10px] uppercase font-bold tracking-widest text-brand-accent mt-0.5">
                  Unforgettable Taste
                </span>
