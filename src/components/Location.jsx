...
export default function Location() {
  return (
    <section id="location" className="relative py-24 bg-black overflow-hidden">
      {/* Decorative details */}
      <div className="absolute top-1/3 right-10 w-96 h-96 bg-brand-red/5 rounded-full blur-[100px] pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-stretch">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between gap-8 text-left">
            ...
            <div className="glass-panel p-8 rounded-3xl border border-white/5 flex gap-6">
              <div className="w-12 h-12 rounded-full bg-brand-red/10 border border-brand-red/20 flex items-center justify-center text-brand-accent shrink-0">
            ...
            <div className="glass-panel p-8 rounded-3xl border border-white/5 flex gap-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400 font-light leading-relaxed">
                  Enjoy cozy <span className="text-white">Dine-in</span> at our luxury red-lit saloon, grab a fast <span className="text-white">Takeaway</span>, or request home <span className="text-white">Delivery</span> anywhere in Jos.
                </p>
              </div>
            </div>
            ...
            <div className="relative w-full h-full min-h-[350px] lg:min-h-0 rounded-2xl overflow-hidden">
              ...
              <div className="absolute top-4 left-4 right-4 flex justify-between items-center pointer-events-auto">
                ...
                <a
                  ...
                  className="px-4 py-2 rounded-xl bg-brand-red hover:bg-brand-red-dark text-xs font-bold text-white flex items-center gap-1.5 shadow-lg shadow-brand-red/30 transition-all active:scale-95"
                >
                  Open in Maps
              ...
              <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                <div className="w-24 h-24 rounded-full bg-brand-red/20 blur-xl animate-pulse" />
              </div>
            </div>
